...
const u32 gObjectEventPic_Shaymin[] = INCBIN_U32("graphics/pokemon/shaymin/overworld.4bpp");
const u32 gObjectEvenetPalette_Shaymin[] = INCBIN_U16("graphics/pokemon/shaymin/overworld_normal.gbapal");