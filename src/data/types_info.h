...
#define FRY_RS (B_CHANGE_DRAGON_FAIRY_VS         ? X(0.5) : X(0.0))  // Dragon     -> Fairy
#define DRG_RS (B_CHANGE_DRAGON_FAIRY_VS         ? X(0.5) : X(2.0))  // Fairy      -> Dragon
...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar
    ...
    [TYPE_DARK]     = {______, ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), STL_RS, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), FRY_RS, ______},
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, DRG_RS, X(2.0), ______, ______},
