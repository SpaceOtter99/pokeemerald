...
static u16 statToPercentage(u16 stat, u16 max)
{
    return(stat * 100) / max;
}
...
static void BufferStat(u8 *dst, s8 natureMod, u32 stat, u32 strId, u32 n)
{
    static const u8 sTextNatureDown[] = _("{COLOR}{05}"); // 07 = light green
    static const u8 sTextNatureUp[] = _("{COLOR}{07}");   // 05 = light red
